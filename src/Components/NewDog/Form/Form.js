 ...
 if(input.temperament.includes(e.target.value)) return
    ...
    if(!errors.name && !errors.height_min && !errors.height_max &&!errors.weight_min && !errors.weight_max) {
      try {
        ...
        setInput({
          image:"",
          name: "",
          height_min: [input.height_min,input.height_max],
          height_max: [input.height_min,input.height_max],
          weight_min: [input.height_min,input.height_max],
          weight_max: [input.height_min,input.height_max],
          life_span_min: "",
          life_span_max: "",
          temperament: []
        })
  ...
  return(
    <div className='Form_container'>
      <h2 className='form_title'>AGREGA LOS DATOS DE TU PERRO</h2>
        ...
        <div>
          <div>
            ...
            <div className={errors.name ? "div_input error" : "div_input"}>
              <input className='form_input' placeholder='Nombre de tu Raza' onChange={handleChange} name="name" value={input.name}/>
            </div>
